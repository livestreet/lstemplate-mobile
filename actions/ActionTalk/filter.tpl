<a href="#" class="button"onclick="ls.tools.slide($('#block_talk_search_content'), $(this));">{$aLang.talk_filter_title}</a>

<br />
<br />
	
<div class="slide slide-bg-grey mb-15" id="block_talk_search_content" {if $_aRequest.submit_talk_filter}style="display:block;" {/if}>
