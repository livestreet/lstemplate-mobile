<button class="button" onclick="jQuery('#block_talk_friends_content').toggle(); return false;">{$aLang.block_friends}</button>


<div class="slide slide-bg-grey mt-10" id="block_talk_friends_content">
	{if $aUsersFriend}
